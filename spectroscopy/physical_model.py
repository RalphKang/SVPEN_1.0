...
def Error_function(data_norm_store, reconstructed_observation,estimated_state):
    ...
    error_group=np.array([error_y,error_reg_0*0.1,error_reg_1*0.1])*data_norm_store.error_zoomer
    error_sum=np.sum(error_group)
    return error_y*data_norm_store.error_zoomer,error_sum*data_norm_store.error_zoomer
